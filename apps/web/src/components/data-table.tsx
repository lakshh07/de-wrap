...
export function DataTable<TData>({
  ...
  pageSize?: number;
  onRowUpdate?: (row: TData) => void;
  detailView?: React.ComponentType<{ item: TData }>;
}) {
...
// Generic detail viewer component
export function TableCellViewer<TData>({
  item,
  detailView,
  formatter,
}: {
  ...
  const displayId = formatter ? formatter(id) : id;
  ...
  return (
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent className="!w-[600px] sm:!max-w-6xl">
